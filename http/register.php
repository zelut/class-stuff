...
if (isset($_POST['submit'])) {
    ...
    mail('christer.edwards@gmail.com', 'Registration', $message, $headers);
...
<body>
    ...
    <!-- password #1 -->
    <b>password:</b>
    <input type="password" name="password1" size="20" tabindex=2 /><br />
    </label>

    <!-- password #2 -->
    <b>password:</b>
    <input type="password" name="password2" size="20" tabindex=3 /><br />
    </label>
